...
<table id = "t1" style="width:100%">
  ...
  <tr>
    ...
    <td><a href="registerloginform.php?formtype=register">Create User</a> <a href="registerloginform.php?formtype=login">Login</a> <a href="">Go to my project</a><a href="input.php">View DB</a></td>
  </tr>
  <tr>
